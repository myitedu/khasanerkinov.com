...
<head>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="/gfolio/{{$theme}}/assets/images/favicon.png" type="image/x-icon">
    <!-- bootstrap -->
    <link rel="stylesheet" href="/gfolio/{{$theme}}/assets/css/bootstrap.min.css">
    <!-- Plugin css -->
    <link rel="stylesheet" href="/gfolio/{{$theme}}/assets/css/plugin.css">
    <!-- Flaticon -->
    <link rel="stylesheet" href="/gfolio/{{$theme}}/assets/css/flaticon.css">
    <!-- stylesheet -->
    <link rel="stylesheet" href="/gfolio/{{$theme}}/assets/css/style.css">
    <link rel="stylesheet" href="/gfolio/{{$theme}}/assets/css/multicolor.css">
    <!-- responsive -->
    <link rel="stylesheet" href="/gfolio/{{$theme}}/assets/css/responsive.css">
</head>
...
<div class="side-menu-wrapper">
    ...
    <div class="side-menu">
        ...
        <ul id="mainmenu-area">
            <li class="current">
                <a href="#home" class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s"><i class="fas fa-home"></i>Home</a>
            </li>
            <li>
                <a href="#about" class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s"><i class="fas fa-user"></i>About</a>
            </li>
            <li>
                <a href="#service" class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s"><i class="fas fa-briefcase"></i>Services</a>
            </li>
            <li>
                <a href="#resume" class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s"><i class="fas fa-file-alt"></i>Resume</a>
            </li>
            <li>
                <a href="#project-gallery" class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s"><i class="fas fa-layer-group"></i>Portfolio</a>
            </li>
            <li>
                <a href="#blog" class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s"><i class="fab fa-blogger"></i>Blog</a>
            </li>
            <li>
                    ...
                    <div class="col-lg-6">
                        <div class="home-content">
                            ...
                            <div class="about-links wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                <a href="#" class="base-btn1">Contact Me</a>
                                <a href="https://www.youtube.com/watch?v=6zM4p_A0ISk" class="base-btn1 video-play mfp-iframe"><i class="fas fa-play"></i>Intro</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="single-counter wow fadeInUp">
                            <img src="/gfolio/{{$theme}}/assets/images/icon/005-target.png" alt="">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-counter wow fadeInUp">
                            <img src="/gfolio/{{$theme}}/assets/images/icon/002-medical-mask.png" alt="">
                            <div class="counter-wrapper">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-counter wow fadeInUp">
                            <img src="/gfolio/{{$theme}}/assets/images/icon/053-success-1.png" alt="">
                            <div class="counter-wrapper">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-counter wow fadeInUp">
                            <img src="/gfolio/{{$theme}}/assets/images/icon/045-hacker.png" alt="">
                            <div class="counter-wrapper">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <a href="service-details.html" class="single-feature wow fadeInUp">
                            <img src="/gfolio/{{$theme}}/assets/images/icon/024-server.png" alt="">
                            <div class="content">
                                <h4 class="title">
                                    Amazon AWS
                                </h4>
                                <p>
                                    technology services, such as computing power, storage, and databases, on an as-needed basis from a cloud provider like Amazon Web Services (AWS).
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <a href="service-details.html" class="single-feature wow fadeInUp">
                            <img src="/gfolio/{{$theme}}/assets/images/icon/062-code-1.png" alt="">
                            <div class="content">
                                <h4 class="title">
                                    Web Development
                                </h4>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="service-details.html" class="single-feature wow fadeInUp">
                            <img src="/gfolio/{{$theme}}/assets/images/icon/064-vector.png" alt="">
                            <div class="content">
                                <h4 class="title">
                                    Creative design
                                </h4>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="service-details.html" class="single-feature wow fadeInUp">
                            <img src="/gfolio/{{$theme}}/assets/images/icon/043-analytics.png" alt="">
                            <div class="content">
                                <h4 class="title">
                                    App Development
                                </h4>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="service-details.html" class="single-feature wow fadeInUp">
                            <img src="/gfolio/{{$theme}}/assets/images/icon/033-rocket.png" alt="">
                            <div class="content">
                                <h4 class="title">
                                    Fast & Optimized
                                </h4>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="service-details.html" class="single-feature wow fadeInUp">
                            <img src="/gfolio/{{$theme}}/assets/images/icon/054-puzzle.png" alt="">
                            <div class="content">
                                <h4 class="title">
                                    Pixel Precision
                                </h4>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="section-heading wow fadeInUp" data-wow-delay="0.2s">
                            <h2 class="title">
                                <i class="fas fa-mug-hot"></i>My Clients
                            </h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="partners-slider wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div class="slider-item">
                            <a href="#">
                                <img src="/gfolio/{{$theme}}/assets/images/partner/4.png" alt="">
                            </a>
                        </div>
                        <div class="slider-item">
                            <a href="#">
                                <img src="/gfolio/{{$theme}}/assets/images/partner/5.png" alt="">
                            </a>
                        </div>
                        <div class="slider-item">
                            <a href="#">
                                <img src="/gfolio/{{$theme}}/assets/images/partner/6.png" alt="">
                            </a>
                        </div>
                        <div class="slider-item">
                            <a href="#">
                                <img src="/gfolio/{{$theme}}/assets/images/partner/7.png" alt="">
                            </a>
                        </div>
                        <div class="slider-item">
                            <a href="#">
                                <img src="/gfolio/{{$theme}}/assets/images/partner/8.png" alt="">
                            </a>
                        </div>
                        <div class="slider-item">
                            <a href="#">
                                <img src="/gfolio/{{$theme}}/assets/images/partner/9.png" alt="">
                            </a>
                        </div>
                        <div class="slider-item">
                            <a href="#">
                                <img src="/gfolio/{{$theme}}/assets/images/partner/10.png" alt="">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="section-heading wow fadeInUp" data-wow-delay="0.2s">
                            <h2 class="title">
                                <i class="fas fa-layer-group"></i>My Portfolio
                            </h2>
                            <div class="right-area">
                                <a href="portfolios.html" class="link">View All</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row project-gallery-item">
                            ...
                            <div class="mix col-md-6 col-lg-4 gallery-item  cat-3 cat-4">
                                <div class="gallery-item-content wow fadeInUp">
                                    <div class="item-thumbnail">
                                        <img src="/gfolio/{{$theme}}/assets/images/work/1.jpg" alt="">
                                        <div class="content-overlay">
                                            <div class="content">
                                                <div class="links">
                                                    <a href="portfolio-details.html" class="link"><i class="fas fa-link"></i></a>
                                                    <a class="img-popup image-preview"
                                                       href="/gfolio/{{$theme}}/assets/images/work/1.jpg">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <div class="mix col-md-6 col-lg-4 gallery-item cat-2 cat-1">
                                <div class="gallery-item-content wow fadeInUp">
                                    <div class="item-thumbnail">
                                        <img src="/gfolio/{{$theme}}/assets/images/work/2.jpg" alt="">
                                        <div class="content-overlay">
                                            <div class="content">
                                                <div class="links">
                                                    <a href="portfolio-details.html" class="link"><i class="fas fa-link"></i></a>
                                                    <a class="img-popup image-preview"
                                                       href="/gfolio/{{$theme}}/assets/images/work/2.jpg">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <div class="mix col-md-6 col-lg-4 gallery-item cat-1 cat-3">
                                <div class="gallery-item-content wow fadeInUp">
                                    <div class="item-thumbnail">
                                        <img src="/gfolio/{{$theme}}/assets/images/work/9.jpg" alt="">
                                        <div class="content-overlay">
                                            <div class="content">
                                                <div class="links">
                                                    <a href="portfolio-details.html" class="link"><i class="fas fa-link"></i></a>
                                                    <a class="img-popup image-preview"
                                                       href="/gfolio/{{$theme}}/assets/images/work/9.jpg">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <div class="mix col-md-6 col-lg-4 gallery-item cat-3 cat-4">
                                <div class="gallery-item-content wow fadeInUp">
                                    <div class="item-thumbnail">
                                        <img src="/gfolio/{{$theme}}/assets/images/work/5.jpg" alt="">
                                        <div class="content-overlay">
                                            <div class="content">
                                                <div class="links">
                                                    <a href="portfolio-details.html" class="link"><i class="fas fa-link"></i></a>
                                                    <a class="img-popup image-preview"
                                                       href="/gfolio/{{$theme}}/assets/images/work/5.jpg">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <div class="mix col-md-6 col-lg-4 gallery-item cat-1 cat-2">
                                <div class="gallery-item-content wow fadeInUp">
                                    <div class="item-thumbnail">
                                        <img src="/gfolio/{{$theme}}/assets/images/work/3.jpg" alt="">
                                        <div class="content-overlay">
                                            <div class="content">
                                                <div class="links">
                                                    <a href="portfolio-details.html" class="link"><i class="fas fa-link"></i></a>
                                                    <a class="img-popup image-preview"
                                                       href="/gfolio/{{$theme}}/assets/images/work/3.jpg">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <div class="mix col-md-6 col-lg-4 gallery-item cat-4 cat-2">
                                <div class="gallery-item-content wow fadeInUp">
                                    <div class="item-thumbnail">
                                        <img src="/gfolio/{{$theme}}/assets/images/work/4.jpg" alt="">
                                        <div class="content-overlay">
                                            <div class="content">
                                                <div class="links">
                                                    <a href="portfolio-details.html" class="link"><i class="fas fa-link"></i></a>
                                                    <a class="img-popup image-preview"
                                                       href="/gfolio/{{$theme}}/assets/images/work/4.jpg">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <div class="mix col-md-6 col-lg-4 gallery-item cat-3 cat-2">
                                <div class="gallery-item-content wow fadeInUp">
                                    <div class="item-thumbnail">
                                        <img src="/gfolio/{{$theme}}/assets/images/work/6.jpg" alt="">
                                        <div class="content-overlay">
                                            <div class="content">
                                                <div class="links">
                                                    <a href="portfolio-details.html" class="link"><i class="fas fa-link"></i></a>
                                                    <a class="img-popup image-preview"
                                                       href="/gfolio/{{$theme}}/assets/images/work/6.jpg">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <div class="mix col-md-6 col-lg-4 gallery-item cat-3 cat-1">
                                <div class="gallery-item-content wow fadeInUp">
                                    <div class="item-thumbnail">
                                        <img src="/gfolio/{{$theme}}/assets/images/work/8.jpg" alt="">
                                        <div class="content-overlay">
                                            <div class="content">
                                                <div class="links">
                                                    <a href="portfolio-details.html" class="link"><i class="fas fa-link"></i></a>
                                                    <a class="img-popup image-preview"
                                                       href="/gfolio/{{$theme}}/assets/images/work/8.jpg">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                </div>
                                            </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="section-heading wow fadeInUp" data-wow-delay="0.2s">
                            <h2 class="title">
                                <i class="fas fa-star"></i>My Testimonial
                            </h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="section-heading wow fadeInUp" data-wow-delay="0.2s">
                            <h2 class="title">
                                <i class="fas fa-tags"></i>Pricing Plan
                            </h2>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="price-box basic wow fadeInUp">
                            ...
                            <div class="buy-btn-wrapper">
                                <a class="base-btn1" href="#">Start Now <i
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="price-box standard wow fadeInUp">
                            ...
                            <div class="buy-btn-wrapper">
                                <a class="base-btn1 price-active" href="#">Start Now <i
                                        class="fas fa-shopping-cart"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="section-heading wow fadeInUp" data-wow-delay="0.2s">
                            <h2 class="title">
                                <i class="fab fa-blogger"></i> My Blogs
                            </h2>
                            <div class="right-area">
                                <a href="blogs.html" class="link">View All</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="blog-slider wow fadeInUp" data-wow-delay="0.3s">
                            <div class="slider-item">
                                <div class="single-blog">
                                    <div class="img">
                                        <img src="/gfolio/{{$theme}}/assets/images/blog/img1.png" alt="">
                                    </div>
                                    <div class="content">
                                        <ul class="top-meta">
                                            <li>
                            ...
                            <div class="slider-item">
                                <div class="single-blog">
                                    <div class="img">
                                        <img src="/gfolio/{{$theme}}/assets/images/blog/img2.png" alt="">
                                    </div>
                                    <div class="content">
                                        <ul class="top-meta">
                                            <li>
                            ...
                            <div class="slider-item">
                                <div class="single-blog">
                                    <div class="img">
                                        <img src="/gfolio/{{$theme}}/assets/images/blog/img3.png" alt="">
                                    </div>
                                    <div class="content">
                                        <ul class="top-meta">
                                            <li>
                            ...
                            <div class="slider-item">
                                <div class="single-blog">
                                    <div class="img">
                                        <img src="/gfolio/{{$theme}}/assets/images/blog/img4.png" alt="">
                                    </div>
                                    <div class="content">
                                        <ul class="top-meta">
                                            <li>
...
<!-- jquery -->
<script src="/gfolio/{{$theme}}/assets/js/jquery.js"></script>
<!-- popper -->
<script src="/gfolio/{{$theme}}/assets/js/popper.min.js"></script>
<!-- bootstrap -->
<script src="/gfolio/{{$theme}}/assets/js/bootstrap.min.js"></script>
<!-- plugin js-->
<script src="/gfolio/{{$theme}}/assets/js/plugin.js"></script>
<script src="/gfolio/{{$theme}}/assets/js/jQuery-plugin-progressbar.js"></script>
<!-- Typed js -->
<script src="/gfolio/{{$theme}}/assets/js/typed.min.js"></script>
<!-- buoyant js -->
<script src="/gfolio/{{$theme}}/assets/js/jquery.buoyant.min.js"></script>
<!-- Wow js -->
<script src="/gfolio/{{$theme}}/assets/js/wow.js"></script>
<!-- main -->
<script src="/gfolio/{{$theme}}/assets/js/main.js"></script>
